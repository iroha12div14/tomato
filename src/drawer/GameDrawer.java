...
public class GameDrawer {
    ...
    public void drawCharacter(Graphics2D g2d, Chara chara) {
        ...
        circle.fill(g2d, Color.RED,
                circle.makeParam(posX + dir * 6, posY - charaHeight + charaWidth / 2, charaWidth, charaWidth),
